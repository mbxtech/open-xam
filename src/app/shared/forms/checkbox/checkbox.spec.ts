...
describe('Checkbox', () => {
    ...
    beforeEach(async () => {
        ...
        fixture.componentRef.setInput('id', 'checkbox');
    ...
    describe('Toggle Functionality', () => {
        ...
        it('should show checkmark SVG when checked', () => {
            inputElement.nativeElement.click();
            const clickableLabel = fixture.debugElement.query(By.css('#checkbox-label'));
            expect(clickableLabel).toBeTruthy();
            clickableLabel.nativeElement.click();
            fixture.detectChanges();

            expect(component['checked']()).toBeTruthy();

            const svg = fixture.debugElement.query(By.css('#check-mark-svg'));
        ...
        it('should apply checked CSS classes when checked', () => {
            ...
            const checkboxDiv = fixture.debugElement.query(
                By.css('div.flex.items-center.justify-center')
            );
